...
MENUS = {
    'en': {
        ...
        'phone_prompt': "⭕️ ONLY 18+ ADULTS ALLOWED TO JOIN THIS NETWORK. PRESS IAM 18+ BUTTON BELOW 👇👇👇👇",
        'phone_denied': "YOU MUST ALLOW TO SHARE YOUR AGE TO JOIN THIS NETWORK. Please try again with /start..",
        'share_button': "⭕️ IAM 18+ ADULT 🙋‍♂️🔞",
    ...
    'si': {
        ...
        'phone_prompt': "⭕️ ඉදිරියට යාම, වයස 18+ වැඩිහිටියන්ට පමණකි. කරුණාකpර පහල බොත්තම ඔබන්න 👇👇👇👇",
        'phone_denied': "ඔබ ඉදිරියට යාමට ඔබගේ සත්‍ය වයස අප හා බෙදාගැනීමට එකඟ වියයුතුමය. කරුණාකර /start සමඟ නැවත උත්සාහ කරන්න.",
        'share_button': "⭕️ මම 18+ වැඩිහිටියෙක්මි 🙋‍♂️🔞",
    ...
    'hi': {
        ...
        'phone_prompt': "⭕️ कार्यवाही केवल 18+ आयु वर्ग के वयस्कों के लिए है। 👇👇👇👇",
        ...
        'share_button': "⭕️ मैं 18+ आयु का वयस्क हूं। 🙋‍♂️🔞",
